...
class ImportWallet extends core_1.Command {
    static description = 'Importing a wallet from bip 39 mnemonic ';
    static flags = {
        // flag with a value (-n, --name=VALUE)
        name: core_1.Flags.string({ char: 'n', description: 'name of wallet', required: true }),
        mnemonic: core_1.Flags.string({ char: 'm', description: 'BIP39 Mnemonic', required: true })
    };
    async run() {
